...
4. **Divi Dual Button Module**: Encourage user interaction and call-to-action with the Advanced Divi Dual Button module. Display two distinct buttons side by side, each with its own customizable text, link, and design options.
5. **Divi Flip Box Module**: Add a touch of interactivity and visual interest to your website with the Advanced Divi Flip Box module. Showcase content on one side of the box, and when hovered or clicked, the box flips to reveal additional information or a different design.
...
= Do I need to have the Divi theme to use Divi Squad Lite? =
...
== Support ==
We offer friendly and responsive support for [Divi Squad Lite](https://squadmodules.com/). If you have any questions or problems, please contact us through our [WordPress support forum](https://wordpress.org/support/plugin/squad-modules-for-divi/).

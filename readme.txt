...
- **Regular Updates**: We are committed to delivering continuous improvements and new features to enhance your experience with Squad Modules for Divi. Expect regular updates and exciting additions to the module collection.
...
Check out the [Divi Squad](https://squadmodules.com/) demos.
...
= Are the modules compatible with the latest version of Divi? =
 Yes, Squad Modules for Divi is regularly tested and updated to ensure compatibility with the latest version of the Divi theme and Divi Builder.

= Can I customize the modules to match my website design? =
 Absolutely! Squad Modules for Divi provides a wide range of customization options, allowing you to adjust colors, typography, spacing, and more to create a cohesive look and feel for your website.

= Will there be additional modules added in the future? =
 Yes, we are continuously working on expanding the module collection and adding new modules with exciting features and functionalities. Stay tuned for updates and announcements.

== Support ==
If you encounter any issues or have questions about Squad Modules for Divi, you can reach out to our support team via the [WordPress support forum](https://wordpress.org/support/plugin/squad-modules-for-divi/) or visit our [website](https://squadmodules.com/) for more information.

== Translations ==
Squad Modules for Divi is translation-ready and supports localization. If you would like to contribute to the translation efforts, please visit the [WordPress translation page](https://translate.wordpress.org/projects/wp-plugins/squad-modules-for-divi) for Squad Modules for Divi.

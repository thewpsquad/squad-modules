<?php
/**
 * Template file to the pro-plugin activation.
 *
 * @since           2.0.0
...
$divi_squad_premium_basename      = divi_squad_get_pro_basename();
$divi_squad_pro_installation_link = esc_url( wp_nonce_url( 'plugins.php?action=activate&amp;plugin=' . $divi_squad_premium_basename, 'activate-plugin_' . $divi_squad_premium_basename ) );
$divi_squad_pro_message           = sprintf(
...
<div class="notice divi-squad-banner divi-squad-success-banner pro-activation-notice is-dismissible">
	...
	<div class="divi-squad-banner-content">
		<h2><?php esc_html_e( 'Approaching closer to unlocking the benefits of the Pro plugin.', 'squad-modules-for-divi' ); ?></h2>
		<p><?php echo wp_kses_post( $divi_squad_pro_message ); ?></p>

		<div class="divi-squad-notice-action">
			<div class="divi-squad-notice-action-left">
				<a href="<?php echo esc_attr( $divi_squad_pro_installation_link ); ?>" target="_blank" class="button-primary divi-squad-notice-action-button">
					<span class="dashicons dashicons-external"></span>
					<p><?php esc_html_e( 'Active Pro Plugin', 'squad-modules-for-divi' ); ?></p>
				</a>
			</div>
		</div>
	</div>

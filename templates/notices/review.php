...
<div class="notice divi-squad-banner divi-squad-review-banner is-dismissible">
	...
	<div class="divi-squad-banner-content">
		...
		<div class="divi-squad-notice-action">
			<div class="divi-squad-notice-action-left">
				<a href="https://wordpress.org/support/plugin/squad-modules-for-divi/reviews/?rate=5#new-post" target="_blank" class="button-primary divi-squad-notice-action-button">
					<span class="dashicons dashicons-external"></span>
					<p><?php esc_html_e( 'Ok, you deserve it!', 'squad-modules-for-divi' ); ?></p>
				</a>
				<a href="#" class="divi-squad-notice-close" style="text-decoration: none;">
					<span class="dashicons dashicons-calendar-alt"></span>
					<p><?php esc_html_e( 'Maybe Later', 'squad-modules-for-divi' ); ?></p>
				</a>
				<a href="#" class="divi-squad-notice-already" style="text-decoration: none;">
					<span class="dashicons dashicons-dismiss"></span>
					<p><?php esc_html_e( 'Never show again', 'squad-modules-for-divi' ); ?></p>
				</a>
			</div>

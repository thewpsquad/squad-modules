...
class FlipBox extends DISQ_Builder_Module {
	...
	public function init() {
			...
			'advanced' => array(
				'toggles' => array(
					...
					'front_content_text'    => array(
						...
						'tabbed_subtoggles' => true,
						'sub_toggles'       => $this->disq_get_block_elements(),
					),
		...
		$this->advanced_fields = array(
			'fonts'          => array(
				'front_icon_text'         => $this->disq_add_font_field(
					...
					array(
						...
						'css'             => array(
							'main'  => "$this->main_css_element div .flip-box-slides .front-slide .disq-icon-wrapper .slide-icon-text",
							'hover' => "$this->main_css_element div .flip-box-slides .front-slide:hover .disq-icon-wrapper .slide-icon-text",
						),
				...
				'back_icon_text'          => $this->disq_add_font_field(
					esc_html__( 'Icon', 'squad-modules-for-divi' ),
					array(
						'text_color'      => array(
							'hover' => false,
						...
						'hide_text_align' => true,
						'css'             => array(
							'main'  => "$this->main_css_element div .flip-box-slides .back-slide .disq-icon-wrapper .slide-icon-text",
							'hover' => "$this->main_css_element div .flip-box-slides .back-slide:hover .disq-icon-wrapper .slide-icon-text",
						),
						'depends_show_if' => 'text',
						'tab_slug'        => 'advanced',
						'toggle_slug'     => 'icon_text',
				...
				'front_title_text'        => $this->disq_add_font_field(
				...
				'back_title_text'         => $this->disq_add_font_field(
					esc_html__( 'Title', 'squad-modules-for-divi' ),
					array(
						'text_color'     => array(
							'hover' => false,
				...
				'front_sub_title_text'    => $this->disq_add_font_field(
				...
				'back_sub_title_text'     => $this->disq_add_font_field(
					esc_html__( 'Sub Title', 'squad-modules-for-divi' ),
					array(
						'text_color'     => array(
							'hover' => false,
				...
				'front_content_text'      => $this->disq_add_font_field(
				...
				'back_content_text'       => $this->disq_add_font_field(
					esc_html__( 'Body', 'squad-modules-for-divi' ),
					array(
						'font_weight'    => array(
							'default' => '400',
				...
				'front_content_heading_1' => $this->disq_add_font_field(
				...
				'back_content_heading_1'  => $this->disq_add_font_field(
					esc_html__( 'Heading 1', 'squad-modules-for-divi' ),
					array(
						'text_color'     => array(
							'hover' => false,
				...
				'front_content_heading_2' => $this->disq_add_font_field(
				...
				'back_content_heading_2'  => $this->disq_add_font_field(
					esc_html__( 'Heading 2', 'squad-modules-for-divi' ),
					array(
						'text_color'     => array(
							'hover' => false,
				...
				'front_content_heading_3' => $this->disq_add_font_field(
				...
				'back_content_heading_3'  => $this->disq_add_font_field(
					esc_html__( 'Heading 3', 'squad-modules-for-divi' ),
					array(
						'text_color'     => array(
							'hover' => false,
				...
				'front_content_heading_4' => $this->disq_add_font_field(
				...
				'back_content_heading_4'  => $this->disq_add_font_field(
					esc_html__( 'Heading 4', 'squad-modules-for-divi' ),
					array(
						'text_color'     => array(
							'hover' => false,
				...
				'front_content_heading_5' => $this->disq_add_font_field(
				...
				'back_content_heading_5'  => $this->disq_add_font_field(
					esc_html__( 'Heading 5', 'squad-modules-for-divi' ),
					array(
						'text_color'     => array(
							'hover' => false,
				...
				'front_content_heading_6' => $this->disq_add_font_field(
				...
				'back_content_heading_6'  => $this->disq_add_font_field(
					esc_html__( 'Heading 6', 'squad-modules-for-divi' ),
					array(
						'text_color'     => array(
							'hover' => false,
				...
				'front_button_text'       => $this->disq_add_font_field(
				...
				'back_button_text'        => $this->disq_add_font_field(
					esc_html__( 'Button', 'squad-modules-for-divi' ),
					array(
						'font_weight'     => array(
							'default' => '400',
			...
			'borders'        => array(
				...
				'front_image_icon'     => array(
					...
					'css'                 => array(
						'main' => array(
							'border_radii'        => "$this->main_css_element div .flip-box-slides .front-slide .disq-icon-wrapper .slide-icon-image",
							'border_radii_hover'  => "$this->main_css_element div .flip-box-slides .front-slide:hover .disq-icon-wrapper .slide-icon-image",
							'border_styles'       => "$this->main_css_element div .flip-box-slides .front-slide .disq-icon-wrapper .slide-icon-image",
							'border_styles_hover' => "$this->main_css_element div .flip-box-slides .front-slide:hover .disq-icon-wrapper .slide-icon-image",
						),
					),
					'hover'               => false,
				...
				'back_image_icon'      => array(
					...
					'css'                 => array(
						'main' => array(
							'border_radii'        => "$this->main_css_element div .flip-box-slides .back-slide .disq-icon-wrapper .slide-icon-image",
							'border_radii_hover'  => "$this->main_css_element div .flip-box-slides .back-slide:hover .disq-icon-wrapper .slide-icon-image",
							'border_styles'       => "$this->main_css_element div .flip-box-slides .back-slide .disq-icon-wrapper .slide-icon-image",
							'border_styles_hover' => "$this->main_css_element div .flip-box-slides .back-slide:hover .disq-icon-wrapper .slide-icon-image",
						),
					),
					'hover'               => false,
		...
		$this->custom_css_fields = array(
			'front_button' => array(
				...
				'selector' => 'div .flip-box .flip-box-slides .front-slide .disq-slide-button',
			),
			'back_button'  => array(
				'label'    => esc_html__( 'Back Button', 'squad-modules-for-divi' ),
				'selector' => 'div .flip-box .flip-box-slides .back-slide .disq-slide-button',
			),
			'wrapper'      => array(
	...
	public function get_fields() {
		...
		$front_text_fields = $this->disq_get_side_text_fields( 'front' );
		$back_text_fields  = $this->disq_get_side_text_fields( 'back' );
		$text_fields       = array_merge( $front_text_fields, $back_text_fields );

		// Icon & Image fields with associated definitions.
		$front_icon_images_fields = $this->disq_get_side_icon_images_fields( 'front' );
		$back_icon_images_fields  = $this->disq_get_side_icon_images_fields( 'back' );
		$icon_images_fields       = array_merge( $front_icon_images_fields, $back_icon_images_fields );

		// Button fields definitions.
		$front_button = $this->disq_get_button_fields(
			array(
				'base_attr_name'       => 'front_button',
				'toggle_slug'          => 'front_button_element',
				'depends_show_if'      => 'on',
				'fields_before_margin' => array(
					'front_button_horizontal_alignment' => $this->disq_add_alignment_field(
		...
		$back_button  = $this->disq_get_button_fields(
			array(
				'base_attr_name'       => 'back_button',
				'toggle_slug'          => 'back_button_element',
				'fields_before_margin' => array(
					'back_button_horizontal_alignment' => $this->disq_add_alignment_field(
						esc_html__( 'Button Alignment', 'squad-modules-for-divi' ),
						array(
							'description'      => esc_html__( 'Align icon to the left, right or center.', 'squad-modules-for-divi' ),
							'type'             => 'align',
		...
		$flip_settings_fields = array(
			'flip_custom_height__enable' => $this->disq_add_yes_no_field(
			...
			'flip_elements_hr_alignment' => $this->disq_add_alignment_field(
			...
			'flip_elements_vr_alignment' => $this->disq_add_select_box_field(
			...
			'flip_swap_slide__enable'    => $this->disq_add_yes_no_field(
		...
		$flip_animations_fields = array(
			'flip_animation_type'          => $this->disq_add_select_box_field(
			...
			'flip_animation_d_lrbt'        => $this->disq_add_select_box_field(
			...
			'flip_animation_d_lr'          => $this->disq_add_select_box_field(
				esc_html__( 'Animation Direction', 'squad-modules-for-divi' ),
				array(
			...
			'flip_animation_d_bt'          => $this->disq_add_select_box_field(
				esc_html__( 'Animation Direction', 'squad-modules-for-divi' ),
				array(
					'description'      => esc_html__( 'Pick from up to two different animation directions, each of which will adjust the starting and ending position of your animated slide.', 'squad-modules-for-divi' ),
			...
			'flip_animation_d_clrbt'       => $this->disq_add_select_box_field(
				esc_html__( 'Animation Direction', 'squad-modules-for-divi' ),
				array(
			...
			'flip_3d_effect__enable'       => $this->disq_add_yes_no_field(
			...
			'flip_move_both_slide__enable' => $this->disq_add_yes_no_field(
		...
		// The animations fields definitions.
		$flip_transitions_fields = $this->disq_add_transition_fields(
			array(
				'base_attr_name' => 'flip',
				'tab_slug'       => 'general',
				'toggle_slug'    => 'fip_animations',
		...
		$front_wrapper_background_fields = $this->disq_add_background_field(
		...
		$back_wrapper_background_fields  = $this->disq_add_background_field(
			esc_html__( 'Wrapper Background', 'squad-modules-for-divi' ),
			array(
		...
		$front_side_assoc_fields = $this->disq_get_side_associate_fields( 'front' );
		$back_side_assoc_fields  = $this->disq_get_side_associate_fields( 'back' );
		$side_assoc_fields       = array_merge( $front_side_assoc_fields, $back_side_assoc_fields );

		// order fields definitions.
		$front_order_fields = $this->disq_get_side_order_fields( 'front' );
		$back_order_fields  = $this->disq_get_side_order_fields( 'back' );
		$order_fields       = array_merge( $front_order_fields, $back_order_fields );

		// Z-Index fields definitions.
		$front_z_index_fields = $this->disq_get_side_z_index_fields( 'front' );
		$back_z_index_fields  = $this->disq_get_side_z_index_fields( 'back' );
	...
	public function render( $attrs, $content, $render_slug ) { // phpcs:ignore Generic.CodeAnalysis.UnusedFunctionParameter.FoundInExtendedClassAfterLastUsed
		...
		$this->disq_generate_animation_styles();
		$this->disq_generate_additional_styles( 'front', $attrs );
		$this->disq_generate_additional_styles( 'back', $attrs );

		$front_slide = sprintf(
			'<div class="flip-slide front-slide et_pb_with_background"><div class="flip-slide-inner">%1$s%2$s</div></div>',
			et_core_esc_previously( $this->disq_render_slide_icons( 'front', $attrs ) ),
			et_core_esc_previously( $this->disq_render_slide_elements( 'front', $attrs ) )
		);
		$back_slide  = sprintf(
			'<div class="flip-slide back-slide et_pb_with_background"><div class="flip-slide-inner">%1$s%2$s</div></div>',
			et_core_esc_previously( $this->disq_render_slide_icons( 'back', $attrs ) ),
			et_core_esc_previously( $this->disq_render_slide_elements( 'back', $attrs ) )
		);
			...
			if ( 'on' === $this->props[ "{$slide_type}_content_outside_container" ] ) {
				...
				if ( $is_desktop || $is_tablet || $is_phone ) {
					...
					$this->generate_styles(
						array(
							'base_attr_name' => "{$slide_type}_icon_horizontal_alignment",
							'selector'       => "$this->main_css_element div .flip-box .flip-box-slides .$slide_type-slide .disq-icon-wrapper",
	...
	private function disq_render_slide_elements( $slide_type, $attrs ) {
		...
		$button_text_element = ( 'on' === $this->prop( "{$slide_type}_button__enable", 'off' ) ) ? $this->disq_render_button_text( $slide_type, $attrs ) : null;
	...
	private function disq_render_button_text( $slide_type, $attrs ) {
		...
		if ( '' !== $button_text ) {
			...
			$button_classes     = $this->disq_add_background_class(
				array(
					'background_field' => "{$slide_type}_button_background_color",
					'classes'          => array(
						'disq-slide-button',
					),
				)
			...
			$font_icon_element = $this->disq_render_button_font_icon( $slide_type );
			$image_element     = $this->disq_render_button_icon_image( $slide_type );
	...
	private function disq_render_button_font_icon( $slide_type ) {
		if ( 'icon' === $this->props[ "{$slide_type}_button_icon_type" ] ) {
			$multi_view   = et_pb_multi_view_options( $this );
			$icon_classes = array( 'et-pb-icon', "disq-{$slide_type}_button-icon" );
	...
	private function disq_render_button_icon_image( $slide_type ) {
		if ( 'icon' === $this->props[ "{$slide_type}_button_icon_type" ] ) {
			$multi_view             = et_pb_multi_view_options( $this );
			$image_classes          = array( "disq-{$slide_type}_button-image", 'et_pb_image_wrap' );
	...
	private function disq_generate_additional_styles( $slide_type, $attrs ) {
		...
		$this->generate_styles(
			array(
				...
				'selector'       => "$this->main_css_element div .flip-box .flip-box-slides .$slide_type-slide .slide-element.disq-icon-wrapper",
				'css_property'   => 'order',
				'render_slug'    => $this->slug,
				'type'           => 'input',
			)
	...
	private function disq_get_side_text_fields( $side ) {
		return array(
			...
			"{$side}_title_tag"      => $this->disq_add_select_box_field(
			...
			"{$side}_sub_title_tag"  => $this->disq_add_select_box_field(
			...
			"{$side}_button__enable" => $this->disq_add_yes_no_field(
	...
	private function disq_get_side_icon_images_fields( $side ) {
		...
		$general_fields = array(
			"{$side}_icon_type" => $this->disq_add_select_box_field(
		...
		$associated_fields = array(
			"{$side}_icon_color"                  => $this->disq_add_color_field(
			...
			"{$side}_image_icon_background_color" => $this->disq_add_color_field(
			...
			"{$side}_image_force_full_width"      => $this->disq_add_yes_no_field(
			...
			"{$side}_icon_default_alignment"      => $this->disq_add_alignment_field(
			...
			"{$side}_content_outside_container"   => $this->disq_add_yes_no_field(
			...
			"{$side}_icon_placement"              => $this->disq_add_placement_field(
			...
			"{$side}_icon_horizontal_alignment"   => $this->disq_add_alignment_field(
				esc_html__( 'Icon Horizontal Alignment', 'squad-modules-for-divi' ),
				array(
					'description'      => esc_html__( 'Align icon to the left, right or center.', 'squad-modules-for-divi' ),
					'default_on_front' => 'left',
			...
			"{$side}_icon_vertical_alignment"     => $this->disq_add_select_box_field(
			...
			"{$side}_icon_wrapper_margin"         => $this->disq_add_margin_padding_field(
			...
			"{$side}_icon_margin"                 => $this->disq_add_margin_padding_field(
	...
	private function disq_get_side_associate_fields( $side ) {
		$wrapper_fields = array(
			"{$side}_text_orientation"    => $this->disq_add_alignment_field(
			...
			"{$side}_wrapper_margin"      => $this->disq_add_margin_padding_field(
		...
		$text_associated_fields = array(
			"{$side}_title_margin"      => $this->disq_add_margin_padding_field(
			...
			"{$side}_sub_title_margin"  => $this->disq_add_margin_padding_field(
			...
			"{$side}_content_margin"    => $this->disq_add_margin_padding_field(
	...
	private function disq_get_side_z_index_fields( $side ) {
		return array(
			"{$side}_icon_z_index"      => $this->disq_z_index_fields(
				array(
			...
			"{$side}_title_z_index"     => $this->disq_z_index_fields(
				array(
			...
			"{$side}_sub_title_z_index" => $this->disq_z_index_fields(
				array(
			...
			"{$side}_body_z_index"      => $this->disq_z_index_fields(
				array(
			...
			"{$side}_button_z_index"    => $this->disq_z_index_fields(
				array(
					'label_prefix' => esc_html__( 'Button', 'squad-modules-for-divi' ),
					'tab_slug'     => 'general',
					'toggle_slug'  => 'item_z_index_element',

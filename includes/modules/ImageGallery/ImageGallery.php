 ...
 * @package         squad-modules-for-divi
 */
class ImageGallery extends Squad_Divi_Builder_Module {
	/**
	 * Initiate Module.
	...
	public function get_fields() {
		...
		$gallery_settings_fields = array(
			'orientation'         => $this->disq_add_select_box_field(
			...
			'gallery_order_by'    => $this->disq_add_select_box_field(
			...
			'images_quantity'     => $this->disq_add_select_box_field(
			...
			'gallery_image_count' => $this->disq_add_range_field(
			...
			'columns_count'       => $this->disq_add_range_field(
			...
			'images_inner_gap'    => $this->disq_add_range_field(
		...
		$overlay_fields = array(
			'zoom_icon_color'     => $this->disq_add_color_field(
			...
			'hover_overlay_color' => $this->disq_add_color_field(
	...
	public function get_transition_fields_css_props() {
		...
		// image styles.
		$this->disq_fix_border_transition( $fields, 'image', "$this->main_css_element div .gallery-images img" );
		$this->disq_fix_box_shadow_transition( $fields, 'image', "$this->main_css_element div .gallery-images img" );
	...
	public function render( $attrs, $content, $render_slug ) { // phpcs:ignore Generic.CodeAnalysis.UnusedFunctionParameter.FoundInExtendedClassAfterLastUsed
		...
		self::set_style(
			...
			array(
				...
				'declaration' => sprintf(
					'--disq-module-gallery-columns: %1$s;',
	...
	public function get_gallery_html( $args = array() ) {
		...
		foreach ( $attachments as $image_index => $attachment ) {
			...
			$image_attrs['class']  = "disq-image $attachment_class";

...
class StarRating extends Squad_Builder_Module {
	...
	public function init() {
		...
		$this->icon_path = Helper::fix_slash( DISQ_MODULES_ICON_DIR_PATH . '/star-rating.svg' );
		...
		$this->advanced_fields = array(
			'fonts'          => array(
				'header'        => $this->disq_add_font_field(
				...
				'rating_number' => $this->disq_add_font_field(
	...
	public function get_fields() {
		// All rating fields.
		$rating_fields = array(
			'rating_scale'   => $this->disq_add_select_box_field(
		...
		$rating_title_fields = array(
			...
			'stars_display_type'     => $this->disq_add_select_box_field(
			...
			'title_inline_position'  => $this->disq_add_select_box_field(
			...
			'title_stacked_position' => $this->disq_add_select_box_field(
		...
		$stars_associated_fields = array(
			'star_alignment' => $this->disq_add_alignment_field(
			...
			'stars_color'    => $this->disq_add_color_field(
		...
		$rating_control_fields = array(
			'show_number' => $this->disq_add_yes_no_field(
		...
		$schema_fields = array(
			'stars_schema_markup'        => $this->disq_add_yes_no_field(
	...
	public function get_transition_fields_css_props() {
		...
		$this->disq_fix_fonts_transition( $fields, 'header', "$this->main_css_element div .star-rating-title" );
		$this->disq_fix_fonts_transition( $fields, 'typed_text', "$this->main_css_element div .star-rating-text" );

...
class Breadcrumbs {
	...
	public function init_wp_ajax_hook() {
		add_action( 'wp_ajax_lwp_get_breadcrumbs', 'lwp_get_breadcrumbs' );
	}

	function disq_get_breadcrumbs() {
		...
		$result = [
			...
			//Title of the Post
			'html'  => lwp_get_hansel_and_gretel_breadcrumbs( $home_text, $before_text, $separator_icon )
			//Breadcrumbs for Post
		];
	...
	function disq_get_hansel_and_gretel_breadcrumbs( $_home_text = 'Home', $_before_text = '', $_delimiter = '&#x39;' ) {

...
class Modules extends ManagerBase {
	...
	public function get_registered_list() {
		return array(
			array(
				'classes'            => array( 'root_class' => \DiviSquad\Modules\Divider::class ),
				'name'               => 'Divider',
			...
			array(
				'classes'            => array( 'root_class' => \DiviSquad\Modules\DualButton::class ),
				'name'               => 'DualButton',
			...
			array(
				'classes'            => array( 'root_class' => \DiviSquad\Modules\Lottie::class ),
				'name'               => 'Lottie',
			...
			array(
				...
				'release_version'    => '1.0.0',
				'last_modified'      => array( '1.0.2', '1.0.4', '1.1.0', '1.2.0', '1.2.2', '1.2.3', '1.4.4', '1.4.8', '1.4.10', '1.4.11', '3.0.0' ),
				'is_default_active'  => true,
				'is_premium_feature' => false,
				'type'               => 'D4',
			...
			array(
				'classes'            => array( 'root_class' => \DiviSquad\Modules\TypingText::class ),
				'name'               => 'TypingText',
			...
			array(
				'classes'            => array( 'root_class' => \DiviSquad\Modules\ImageMask::class ),
				'name'               => 'ImageMask',
			...
			array(
				'classes'            => array( 'root_class' => \DiviSquad\Modules\FlipBox::class ),
				'name'               => 'FlipBox',
			...
			array(
				'classes'            => array( 'root_class' => \DiviSquad\Modules\BeforeAfterImageSlider::class ),
			...
			array(
				'classes'            => array( 'root_class' => \DiviSquad\Modules\ImageGallery::class ),
				'name'               => 'ImageGallery',
			...
			array(
				'classes'            => array( 'root_class' => \DiviSquad\Modules\FormStylers\ContactForm7::class ),
			...
			array(
				'classes'            => array( 'root_class' => \DiviSquad\Modules\FormStylers\GravityForms::class ),
			...
			array(
				'classes'            => array( 'root_class' => \DiviSquad\Modules\PostReadingTime::class ),
			...
			array(
				'classes'            => array( 'root_class' => \DiviSquad\Modules\GlitchText::class ),
				'name'               => 'GlitchText',
			...
			array(
				'classes'            => array( 'root_class' => \DiviSquad\Modules\GradientText::class ),
				'name'               => 'GradientText',
			...
			array(
				'classes'            => array( 'root_class' => \DiviSquad\Modules\ScrollingText::class ),
				'name'               => 'ScrollingText',
			...
			array(
				'classes'            => array( 'root_class' => \DiviSquad\Modules\StarRating::class ),
				'name'               => 'StarRating',
			...
			array(
				'classes'            => array( 'root_class' => \DiviSquad\Modules\Breadcrumbs::class ),
				'name'               => 'Breadcrumbs',
			...
			array(
				'classes'            => array( 'root_class' => \DiviSquad\Modules\DropCapText::class ),
				'name'               => 'DropCapText',
			...
			array(
				'classes'            => array( 'root_class' => \DiviSquad\Modules\VideoPopup::class ),
				'name'               => 'VideoPopup',
			...
			array(
				'classes'            => array( 'root_class' => \DiviSquad\Modules\GoogleMap::class ),
				'name'               => 'GoogleMap',
			...
			array(
				'classes'            => array( 'root_class' => \DiviSquad\Modules\FormStylers\NinjaForms::class ),
			...
			array(
				'classes'            => array( 'root_class' => \DiviSquad\Modules\FormStylers\FluentForms::class ),
